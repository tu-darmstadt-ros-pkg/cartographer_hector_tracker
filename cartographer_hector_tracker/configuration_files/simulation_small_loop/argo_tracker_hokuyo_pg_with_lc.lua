...
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.ceres_solver_options.max_num_iterations = 60
...
TRAJECTORY_BUILDER_3D.tsdfs.high_resolution = 0.2
...
MAP_BUILDER.sparse_pose_graph.constraint_builder.min_score = 0.55
MAP_BUILDER.sparse_pose_graph.constraint_builder.log_matches = true
MAP_BUILDER.map_type = "PROBABILITY_GRID"

TRAJECTORY_BUILDER_3D.optimizing_local_trajectory_builder.scans_per_map_update = 30
...
TRAJECTORY_BUILDER_3D.optimizing_local_trajectory_builder.velocity_weight = 8e2
TRAJECTORY_BUILDER_3D.optimizing_local_trajectory_builder.translation_weight = 1e4
TRAJECTORY_BUILDER_3D.optimizing_local_trajectory_builder.rotation_weight = 2e3
TRAJECTORY_BUILDER_3D.optimizing_local_trajectory_builder.odometry_translation_weight = 7e2
TRAJECTORY_BUILDER_3D.optimizing_local_trajectory_builder.odometry_rotation_weight = 7e2
