...
POSE_GRAPH.constraint_builder.min_score = 0.93
...
TRAJECTORY_BUILDER_3D.optimizing_local_trajectory_builder.high_resolution_grid_weight = 60.
...
TRAJECTORY_BUILDER_3D.optimizing_local_trajectory_builder.initialize_map_orientation_with_imu = false
...
TRAJECTORY_BUILDER_3D.submaps.range_data_inserter.tsdf_range_data_inserter.truncation_distance = 0.3
