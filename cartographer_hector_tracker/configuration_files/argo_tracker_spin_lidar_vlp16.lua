...
TRAJECTORY_BUILDER_3D.optimizing_local_trajectory_builder.scans_per_map_update = 10
TRAJECTORY_BUILDER_3D.optimizing_local_trajectory_builder.scans_per_optimization_update = 5
